...
import handlers.KingMoveHandler;
...
/**
 * Validates king chess moves
 */
public class KingMoveStrategy implements MoveStrategy {
    /**
     * Checks whether a move is valid for a king
     *
     ...
     */
    @Override
    public boolean validateMove(final Board board, final Square from, final Square to) {
