...
import handlers.DiagonalMoveHandler;
...
public class DiagonalMoveStrategy implements MoveStrategy {
    ...
    private Handler buildValidationChain() {
        ...
        validBoard
                ...
                .setNext(new DiagonalMoveHandler())
