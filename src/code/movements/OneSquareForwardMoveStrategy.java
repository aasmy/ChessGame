...
import handlers.OneSquareForwardHandler;
import handlers.ValidBoardHandler;
import handlers.ValidDestinationHandler;
import handlers.ValidStartLocationHandler;

/**
 * Validates one square forward pawn moves
 */
public class OneSquareForwardMoveStrategy implements MoveStrategy {
    /**
     * Checks whether a pawn can move one square forward
     *
     * @param board the board where the move is checked
     * @param from the starting square
     * @param to the destination square
     * @return true if the pawn can move one square forward
     */
    @Override
    ...
    private Handler buildValidationChain() {
        ...
        validBoard
                ...
                .setNext(new OneSquareForwardHandler());
